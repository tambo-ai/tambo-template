  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 max-w-xl w-full mb-8">
      <h2 className="text-xl font-bold text-gray-900 mb-4">
        👋 Welcome to the Tambo Starter!
      </h2>
      <p className="text-gray-700 mb-4">
        This app is set up with a &quot;ProductCard&quot; component registered
        with Tambo to show how to build an AI-powered web app.
      </p>
      <p className="text-gray-700 mb-4">
        Try sending a message to see our product card component in action. Based
        on the message, Tambo will look at the product data and generate the
      ...
      <p className="text-gray-500 text-sm mt-4 italic">
        Tip: Find the available products in{' '}
